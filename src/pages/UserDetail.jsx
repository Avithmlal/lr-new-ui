...
export function UserDetail() {
  ...
  useEffect(() => {
    // Redirect if no permission or user not found
    if (!canViewUsers) {
      navigate('/');
      dispatch({
  ...
  }, [canViewUsers, user, navigate, dispatch]);
      ...
      <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start space-x-3">
        ...
        <div>
          ...
          <p className="text-sm text-red-800">
            You're viewing this page with administrative privileges. You can manage all aspects of this user account.
          </p>
        </div>
      </div>
